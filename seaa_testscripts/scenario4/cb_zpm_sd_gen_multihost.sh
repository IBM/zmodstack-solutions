...
# Pre-Req export Env/Ansible Variable to run Scenario
# ***********************************
export WORKING_DIR=${SEAA_CONFIG_PATH_TO_SE_ANSIBLE_ARTIFACTS}/../../../seaa_testscripts/scenario4
export INVENTORY_LOCATION=${WORKING_DIR}/inventory
export INVENTORY=cb_zpm_sd_multihost.yaml
...
# Pre-Req export Env/Ansible Variable to run Scenario
# ***********************************
export ADMIN_NAMESPACES='"zstack-se-cb-zpm-sd-gen-multi"'
...
extravars_file="${WORKING_DIR}/extravars/cb_zpm_sd_gen_multihost.json"
