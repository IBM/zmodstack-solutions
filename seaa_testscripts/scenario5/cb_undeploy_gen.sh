...
# Pre-Req export Env/Ansible Variable to run Scenario
# ***********************************
export WORKING_DIR=${SEAA_CONFIG_PATH_TO_SE_ANSIBLE_ARTIFACTS}/../../../seaa_testscripts/scenario5
export INVENTORY_LOCATION=${WORKING_DIR}/inventory
export INVENTORY=cb_undeploy.yaml
...
# Pre-Req export Env/Ansible Variable to run Scenario
# ***********************************
export ADMIN_NAMESPACES='"zstack-se-cb-und-gen"'
...
$run_step && echo "Admin - Undeploy Admin Project and CB"
