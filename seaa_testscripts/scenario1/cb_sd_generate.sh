...
# Pre-Req export Env/Ansible Variable to run Scenario
# ***********************************
export WORKING_DIR=${SEAA_CONFIG_PATH_TO_SE_ANSIBLE_ARTIFACTS}/../../../seaa_testscripts/scenario1
export INVENTORY_LOCATION=${WORKING_DIR}/inventory
export INVENTORY=cb_sd_singlehost.yaml
...
# Pre-Req export Env/Ansible Variable to run Scenario
# ***********************************
export ADMIN_NAMESPACES='"zstack-se-zoscb-sd-gen"'
...
extravars_file="${WORKING_DIR}/extravars/cb_sd_gen.json"
